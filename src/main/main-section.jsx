        ...
        <section className='container'>
            <div className='images-wrapper'>
                ...
                <div className="images">
                    <img className='mini-image' tabIndex="0" src={firstProduct} alt="images" />
                    <img className='mini-image' tabIndex="0" src={secondProduct} alt="images" />
                    <img className='mini-image' tabIndex="0" src={thirdProduct} alt="images" />
                    <img className='mini-image' tabIndex="0" src={fourProduct} alt="images" />
                </div>
            </div>
            <div className='right-wrapper'>
                ...
                <h1 className='price'> $125.00<span className='discount'>50%</span></h1>
